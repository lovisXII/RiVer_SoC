...
SC_MODULE(wb_bus)
{
    ...
    river1_inst("IP_RIVER1")
    {
        ...
        arbiter_inst.ADR_I(ADR_0);
        arbiter_inst.CYC_0_I(CYC_REQ_0);
        arbiter_inst.CYC_O(CYC_0);
        arbiter_inst.GRANT_0_O(GRANT_0);
        arbiter_inst.SEL_0_O(SELECT_0);

        ram_inst.CLK(CLK);
        ram_inst.RESET_N(RESET_N);
        ram_inst.DAT_I(DAT_M0);
        ram_inst.ADR_I(ADR_0);
        ram_inst.CYC_I(CYC_0);
        ram_inst.SEL_I(SEL_0);
        ram_inst.STB_I(STB_0);
        ram_inst.WE_I(WE_0);
