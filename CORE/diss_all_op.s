...
00010054 <_start>:
   ...
   100cc:	00508463          	beq	ra,t0,100d4 <_start+0x80> # ra = 4294967286 | t0 = 4294967286

   100cc:	00508463          	beq	ra,t0,100d4 <_start+0x80>
   100d0:	f31ef06f          	j	0 <_bad>

   100d4:	00106313          	ori	t1,zero,1 # t1 = 1
   100d8:	01d31313          	slli	t1,t1,0x1d # t1 = 536870912

   100d8:	01d31313          	slli	t1,t1,0x1d 
   100dc:	00125093          	srli	ra,tp,0x1 # ra = 4294967268 | pbl ici tp = 0

   100e0:	0060d463          	bge	ra,t1,100e8 <_start+0x94> #r1 = 4294967268 | t1 = 536870912, ra < t1
