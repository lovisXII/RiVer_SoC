...
void alu_s2::trace(sc_trace_file* tf) {
...
void shifter_s2::shifter_agregate() {
    if (sll_se.read()) {
...
void shifter_s2::trace(sc_trace_file* tf) {
...
void exec_s2::fifo_unconcat() {
    ...
    CSR_WADR_RE_S2.write((sc_bv_base)ff_dout.range(120, 109));
...
void exec_s2::exception() {
    ...
    {
        INTERRUPTION_SE_S2.write(1);
    } else {
        INTERRUPTION_SE_S2.write(0);
    }
...
void exec_s2::trace(sc_trace_file* tf) {
    ...
    sc_trace(tf, MACHINE_TIMER_INTERRUPT_SE_S2, GET_NAME(MACHINE_TIMER_INTERRUPT_SE_S2));
    sc_trace(tf, MACHINE_EXTERNAL_INTERRUPT_SE_S2, GET_NAME(MACHINE_EXTERNAL_INTERRUPT_SE_S2));
    ...
    sc_trace(tf, CSR_WADR_RE_S2, GET_NAME(CSR_WADR_RE_S2));
