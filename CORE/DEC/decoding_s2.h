...
void decod::pre_reg_read_decoding_s2() {
    ...
    // system-type Instruction
        ...
        if (csrrw_i_sd_s2 || csrrs_i_sd_s2 || csrrc_i_sd_s2 || csrrwi_i_sd_s2 || csrrsi_i_sd_s2 || csrrci_i_sd_s2) {
            ...
            if (CURRENT_MODE_SM_S1.read() == 0 && ecall_i_sd_s2) {
                env_call_u_mode_sd_s2 = 1;
                env_call_s_mode_sd_s2 = 0;
                env_call_m_mode_sd_s2 = 0;
            } else if (ecall_i_sd_s2 && CURRENT_MODE_SM_S1.read() == 3) {
            ...
            if (mret_i_sd_s2 && CURRENT_MODE_SM_S1.read() != 3) {
                env_call_wrong_mode_s2 = 1;
            } else if (sret_i_sd_s2 && CURRENT_MODE_SM_S1.read() != 2)
...
void decod::post_reg_read_decoding_s2() {
    ...
    // inc_pc_sd_s2.write(((inc_pc_var || IF2DEC_EMPTY_SI_S1) && dec2if_push_sd.read()) && !EXCEPTION_SM_S1);
    // add_offset_to_pc_sd.write((!stall_sd_s1 && !inc_pc_var && (b_type_inst_sd_s2 || j_type_inst_sd_s2
