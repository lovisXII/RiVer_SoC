...
void decod::decoding_instruction_type_s1() {
    sc_uint<32> if_ir1   = INSTR_RI_S1.read();
    r_type_inst_sd_s1      = (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) != 0b0000001) ? 1 : 0;
    i_type_inst_sd_s1      = (if_ir1.range(6, 0) == 0b0010011 | if_ir1.range(6, 0) == 0b0000011) ? 1 : 0;
    s_type_inst_sd_s1      = if_ir1.range(6, 0) == 0b0100011 ? 1 : 0;
    b_type_inst_sd_s1      = if_ir1.range(6, 0) == 0b1100011 ? 1 : 0;
    u_type_inst_sd_s1      = (if_ir1.range(6, 0) == 0b0110111 || if_ir1.range(6, 0) == 0b0010111) ? 1 : 0;
    j_type_inst_sd_s1      = if_ir1.range(6, 0) == 0b1101111 ? 1 : 0;
    jalr_type_inst_sd_s1   = if_ir1.range(6, 0) == 0b1100111 ? 1 : 0;
    system_type_inst_sd_s1 = if_ir1.range(6, 0) == 0b1110011 ? 1 : 0;
    m_type_inst_sd_s1      = (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0000001) ? 1 : 0;
}
...
void decod::decoding_instruction_s1() {
    ...
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b000)
        add_i_sd_s1.write(1);
    else
        add_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b010)
        slt_i_sd_s1.write(1);
    else
        slt_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b011)
        sltu_i_sd_s1.write(1);
    else
        sltu_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b111)
        and_i_sd_s1.write(1);
    else
        and_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b110)
        or_i_sd_s1.write(1);
    else
        or_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b100)
        xor_i_sd_s1.write(1);
    else
        xor_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b001)
        sll_i_sd_s1.write(1);
    else
        sll_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b101)
        srl_i_sd_s1.write(1);
    else
        srl_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0100000 && if_ir1.range(14, 12) == 0b000)
        sub_i_sd_s1.write(1);
    else
        sub_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(31, 25) == 0b0100000 && if_ir1.range(14, 12) == 0b101)
        sra_i_sd_s1.write(1);
    else
        sra_i_sd_s1.write(0);
    ...
    if (if_ir1.range(6, 0) == 0b0010011 && if_ir1.range(14, 12) == 0b000)
        addi_i_sd_s1.write(1);
    else
        addi_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0010011 && if_ir1.range(14, 12) == 0b010)
        slti_i_sd_s1.write(1);
    else
        slti_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0010011 && if_ir1.range(14, 12) == 0b011)
        sltiu_i_sd_s1.write(1);
    else
        sltiu_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0010011 && if_ir1.range(14, 12) == 0b111)
        andi_i_sd_s1.write(1);
    else
        andi_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0010011 && if_ir1.range(14, 12) == 0b110)
        ori_i_sd_s1.write(1);
    else
        ori_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0010011 && if_ir1.range(14, 12) == 0b100)
        xori_i_sd_s1.write(1);
    else
        xori_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0001111 && if_ir1.range(14, 12) == 0b000)
    ...
    if (if_ir1.range(6, 0) == 0b0010011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b001)
        slli_i_sd_s1.write(1);
    else
        slli_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0010011 && if_ir1.range(31, 25) == 0b0000000 && if_ir1.range(14, 12) == 0b101)
        srli_i_sd_s1.write(1);
    else
        srli_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0010011 && if_ir1.range(31, 25) == 0b0100000 && if_ir1.range(14, 12) == 0b101)
    ...
    if (if_ir1.range(6, 0) == 0b0000011 && if_ir1.range(14, 12) == 0b010)
        lw_i_sd_s1.write(1);
    else
        lw_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0000011 && if_ir1.range(14, 12) == 0b001)
        lh_i_sd_s1.write(1);
    else
        lh_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0000011 && if_ir1.range(14, 12) == 0b101)
        lhu_i_sd_s1.write(1);
    else
        lhu_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0000011 && if_ir1.range(14, 12) == 0b000)
        lb_i_sd_s1.write(1);
    else
        lb_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0000011 && if_ir1.range(14, 12) == 0b100)
        lbu_i_sd_s1.write(1);
    else
        lbu_i_sd_s1.write(0);
    ...
    if (if_ir1.range(6, 0) == 0b1100011 && if_ir1.range(14, 12) == 0b000)
        beq_i_sd_s1.write(1);
    else
        beq_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1100011 && if_ir1.range(14, 12) == 0b001)
        bne_i_sd_s1.write(1);
    else
        bne_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1100011 && if_ir1.range(14, 12) == 0b100)
        blt_i_sd_s1.write(1);
    else
        blt_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1100011 && if_ir1.range(14, 12) == 0b101)
        bge_i_sd_s1.write(1);
    else
        bge_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1100011 && if_ir1.range(14, 12) == 0b110)
        bltu_i_sd_s1.write(1);
    else
        bltu_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1100011 && if_ir1.range(14, 12) == 0b111)
    ...
    if (if_ir1.range(6, 0) == 0b0110111)
        lui_i_sd_s1.write(1);
    else
        lui_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0010111)
    ...
    if (if_ir1.range(6, 0) == 0b1101111)
        jal_i_sd_s1.write(1);
    else
        jal_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1100111)
    ...
    if (if_ir1.range(6, 0) == 0b0100011 && if_ir1.range(14, 12) == 0b010)
        sw_i_sd_s1.write(1);
    else
        sw_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0100011 && if_ir1.range(14, 12) == 0b001)
        sh_i_sd_s1.write(1);
    else
        sh_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0100011 && if_ir1.range(14, 12) == 0b000)
        sb_i_sd_s1.write(1);
    else
        sb_i_sd_s1.write(0);
    ...
    if (if_ir1.range(6, 0) == 0b1110011 && if_ir1.range(14, 12) == 0b000 && if_ir1.range(31, 20) == 0b000000000000)
        ecall_i_sd_s1.write(1);
    else
        ecall_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1110011 && if_ir1.range(14, 12) == 0b000 && if_ir1.range(31, 20) == 0b000000000001)
        ebreak_i_sd_s1.write(1);
    else
        ebreak_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1110011 && if_ir1.range(14, 12) == 0b001)
        csrrw_i_sd_s1.write(1);
    else
        csrrw_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1110011 && if_ir1.range(14, 12) == 0b010)
        csrrs_i_sd_s1.write(1);
    else
        csrrs_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1110011 && if_ir1.range(14, 12) == 0b011)
        csrrc_i_sd_s1.write(1);
    else
        csrrc_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1110011 && if_ir1.range(14, 12) == 0b101)
        csrrwi_i_sd_s1.write(1);
    else
        csrrwi_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1110011 && if_ir1.range(14, 12) == 0b110)
        csrrsi_i_sd_s1.write(1);
    else
        csrrsi_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b1110011 && if_ir1.range(14, 12) == 0b111)
        csrrci_i_sd_s1.write(1);
    else
        csrrci_i_sd_s1.write(0);
    if (if_ir1 == 0b00110000001000000000000001110011)
        mret_i_sd_s1.write(1);
    else
        mret_i_sd_s1.write(0);
    if (if_ir1 == 0b00010000001000000000000001110011)
    ...
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(14, 12) == 0b000 && if_ir1.range(31, 25) == 0b0000001)
        mul_i_sd_s1.write(1);
    else
        mul_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(14, 12) == 0b001 && if_ir1.range(31, 25) == 0b0000001)
        mulh_i_sd_s1.write(1);
    else
        mulh_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(14, 12) == 0b010 && if_ir1.range(31, 25) == 0b0000001)
        mulhsu_i_sd_s1.write(1);
    else
        mulhsu_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(14, 12) == 0b011 && if_ir1.range(31, 25) == 0b0000001)
        mulhu_i_sd_s1.write(1);
    else
        mulhu_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(14, 12) == 0b100 && if_ir1.range(31, 25) == 0b0000001)
        div_i_sd_s1.write(1);
    else
        div_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(14, 12) == 0b101 && if_ir1.range(31, 25) == 0b0000001)
        divu_i_sd_s1.write(1);
    else
        divu_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(14, 12) == 0b110 && if_ir1.range(31, 25) == 0b0000001)
        rem_i_sd_s1.write(1);
    else
        rem_i_sd_s1.write(0);
    if (if_ir1.range(6, 0) == 0b0110011 && if_ir1.range(14, 12) == 0b111 && if_ir1.range(31, 25) == 0b0000001)
...
void decod::pre_reg_read_decoding_s1() {
    ...
    if (r_type_inst_sd_s1 == 1) {
        radr1_var    = if_ir1.range(19, 15);
        radr2_var    = if_ir1.range(24, 20);
        adr_dest_var = if_ir1.range(11, 7);
        CSR_RADR_SD.write(0);
    }
    // I-type Instruction :
    ...
    // system-type Instruction
        ...
        if (csrrw_i_sd_s1 || csrrs_i_sd_s1 || csrrc_i_sd_s1 || csrrwi_i_sd_s1 || csrrsi_i_sd_s1 || csrrci_i_sd_s1) {
            CSR_RADR_SD.write(if_ir1.range(31, 20));
            csr_radr_sd_s1  = if_ir1.range(31, 20);
            radr1_var    = (csrrw_i_sd_s1 | csrrs_i_sd_s1 | csrrc_i_sd_s1) ? if_ir1.range(19, 15) : 0;
            radr2_var    = 0;
            adr_dest_var = if_ir1.range(11, 7);
    ...
    adr_dest_sd_s1.write(adr_dest_var);
}
...
void decod::post_reg_read_decoding_s1() {
    ...
    if (r_type_inst_sd_s1 || i_type_inst_sd_s1 || u_type_inst_sd_s1 || m_type_inst_sd_s1) {
        ...
        dec2exe_op2_var.range(11, 5) = if_ir1.range(31, 25);
        dec2exe_op2_var.range(4, 0)  = if_ir1.range(11, 7);
        ...
        offset_branch_var.range(12, 12) = if_ir1.range(31, 31);
        offset_branch_var.range(11, 11) = if_ir1.range(7, 7);
        offset_branch_var.range(10, 5)  = if_ir1.range(30, 25);
        offset_branch_var.range(4, 1)   = if_ir1.range(11, 8);
        ...
        if (jalr_type_inst_sd_s1) {
            ...
            offset_branch_var.range(11, 0) = if_ir1.range(31, 20);
            ...
            offset_branch_var.range(20, 20) = if_ir1.range(31, 31);
            offset_branch_var.range(19, 12) = if_ir1.range(19, 12);
            offset_branch_var.range(11, 11) = if_ir1.range(20, 20);
            offset_branch_var.range(10, 1)  = if_ir1.range(30, 21);
            offset_branch_var.range(0, 0)   = 0;
            mem_data_var                    = 0;
            not_jump_var                      = 0;
        }
        ...
        if (csrrw_i_sd_s1 || csrrs_i_sd_s1 || csrrc_i_sd_s1 || csrrwi_i_sd_s1 || csrrsi_i_sd_s1 || csrrci_i_sd_s1) {
            ...
            if (csrrw_i_sd_s1 | csrrc_i_sd_s1 | csrrs_i_sd_s1) {
                ...
                if (!csrrci_i_sd_s1)
                    dec2exe_op1_var = if_ir1.range(19, 15);
                else
                    dec2exe_op1_var = ~if_ir1.range(19, 15);
            }
    ...
    if (r_type_inst_sd_s1) {
        if (if_ir1.range(31, 25) != 0 && if_ir1.range(31, 25) != 0b0100000) { illegal_inst = true; }
    } else if (b_type_inst_sd_s1) {
        if (if_ir1.range(14, 12) == 2 || if_ir1.range(14, 12) == 3) illegal_inst = true;
    }

    else if (s_type_inst_sd_s1) {
        if (if_ir1.range(14, 12) > 2) illegal_inst = true;
    } else if (system_type_inst_sd_s1)
        if (if_ir1.range(14, 12) == 4) illegal_inst = true;

    illegal_inst = illegal_inst && !IF2DEC_EMPTY_SI.read();

    illegal_instruction_sd_s1.write(illegal_inst);
    block_bp_sd_s1.write(jalr_type_inst_sd_s1);
    exe_wb_sd_s1.write(dec2exe_wb_var);
    offset_branch_sd_s1.write(offset_branch_var);
    exe_op1_sd_s1.write(dec2exe_op1_var);
    exe_op2_sd_s1.write(dec2exe_op2_var);
    mem_data_sd_s1.write(mem_data_var);
