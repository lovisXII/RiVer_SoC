        ...
        exec_inst_s2.MACHINE_TIMER_INTERRUPT_SE_S1(MACHINE_TIMER_INTERRUPT_SE_S1);
        exec_inst_s2.MACHINE_EXTERNAL_INTERRUPT_SE_S1(MACHINE_EXTERNAL_INTERRUPT_SE_S1);
