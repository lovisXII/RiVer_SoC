...
int sc_main(int argc, char* argv[]) {
    ...
    //     sc_trace(tf,unit_exec.SELECT_SHIFT,"SELECT_SHIFT") ;//taille fifo
    //     entrée : 110 sc_trace(tf,unit_exec.EXE2MEM_POP,"EXE2MEM_POP");
    ...
    //     sc_trace(tf,unit_exec.FFOUT_MEM_SIGN_EXTEND,"FFOUT_MEM_SIGN_EXTEND")
    //     ;//taille fifo sortie : 76
