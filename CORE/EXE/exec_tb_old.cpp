...
int sc_main(int argc, char* argv[])
{
    ...
    for (i = 0; i < NB_TEST; i++) {
        ...
        cout << "dec2exe_empty "<< unit_exec.DEC2EXE_EMPTY.read() << endl ;
        cout << "Calcul interne à EXE :" << endl ;
        cout << "op1 :" << unit_exec.OP1.read() << endl ;
        cout << "cmd :" << unit_exec.CMD.read() << endl ;
        cout << "alu_res : " << unit_exec.FFIN_EXE_RES.read() << endl ;
        cout << "Interface avec exe2mem : " << endl ;

        cout << "Fifo input : " << unit_exec.FF_DIN.read() << endl ;
        cout << "Push :" << unit_exec.EXE2MEM_PUSH.read() << endl ;
        cout << "Pop :" << unit_exec.EXE2MEM_POP.read() << endl ;
        cout << "empty : " << unit_exec.EXE2MEM_EMPTY.read() << endl ;
        cout << "FF_OUT :" << unit_exec.FF_DOUT.read() << endl ;
        cout << "fifo valid bit :" << unit_exec.fifo_inst.fifo_v.read() << endl ;
        cout << "fifo push interne :" << unit_exec.fifo_inst.PUSH.read() << endl ;
        cout << "fifo pop interne :" << unit_exec.fifo_inst.POP.read() << endl ;
         cout << "fifo din interne :" << unit_exec.fifo_inst.DIN.read() << endl ;
          cout << "fifo dout interne :" << unit_exec.fifo_inst.DOUT.read() << endl ;
          
          cout << "fifo dout interne :" << unit_exec.fifo_inst.data_inside.read() << endl ;
